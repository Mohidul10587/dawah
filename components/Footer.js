...
const Footer = () => {
  return (
    <div className="mt-20">
      <div className="bg-gray-700 flex sm:p-3 p-2">
        ...
        <div className="w-1/2 sm:p-6 p-2">
          ...
          <div className="flex">
            <svg
              ...
              strokeWidth="0"
              viewBox="0 0 448 512"
              className="hover:bg-white bg-white text-gray-700 border-1 mr-2 text-2xl"
              height="1em"
              width="1em"
      ...
      <div className="bg-gray-700 text-white text-center py-3 border-t">
        <p>
          © Copyright By<span> Mohid </span>
        </p>
      </div>
    </div>
  );
